      ...
      <div className="py-20 flex justify-center  relative bg-[#1B1918]">
        <div className="w-full max-w-[1140px] ">
          <div className="flex mob:block w-full justify-between items-center max-w-[1140px] my-8">
            {/* left text */}
            <div className="">
              <h1 className="text-[50px] font-outfit  font-medium leading-[63px] text-gradient mb-5">
                Updates Coming Soon!
              </h1>
              <h2 className="text-[20px] tracking-[3px] font-jakrata uppercase font-normal leading-[25.2px] text-[#FFFFFF]/60">
            ...
            <div className="">
              <div className="mt-9 flex justify-center">
                <button className=" py-[20px] px-[40px] tracking-[1px] rounded-[150px] bg-[#FFFFFF] text-[#121212] text-[15px] leading-[18.9px] uppercase font-semibold font-jakrata">
                  View All Events
                </button>
              </div>
            </div>
          ...
          <div className=" w-full  max-w-[1140px] my-20 relative">
            ...
            <div className="flex mob:block justify-between items-center">
              <div className="flex items-center gap-[30px] w-[670px]">
                ...
                {/* text */}
                <p className="text-[22px] text-[#FFFFFF] leading-[27.72px] font-medium font-outfit">
                  Radio <br /> Interview
                </p>
              </div>
              {/* center time */}
        ...
        <div className="absolute z-20  top-[230px] inset-0 bg-gradient-to-b from-[#1B1918]/40 to-[#1B1918] h-[60%] mob:h-full"></div>
      </div>
    </>
  );
};
