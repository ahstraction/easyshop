...
const AboutProducer = () => {
  return (
    <>
      <div className=" 2xl:container-fluid flex min-h-[986px] items-center justify-center  mx-auto overflow-hidden relative ">
        <Image
          src={bg}
        ...
        <div className="h-full flex items-center justify-center min-h-[986px] relative max-w-[1290px] w-full">
          <Image
            src={bgright}
          ...
          <div className=" flex mob:block items-end gap-[210px] relative z-20 mob:px-5 ">
            <div className="flex  justify-end tab:justify-center items-center">
              <div className=" relative w-full max-w-[674px] px-[2%]">
                <h1 className="text-[#FFFFFF] mob:text-center uppercase font-normal font-jakrata text-[20px] leading-[25.2px] tracking-[3px]">
                  About the Producer
                </h1>
                <h2 className="text-gradient mob:text-center text-left font-outfit font-medium text-[70px] mob:text-[30px] leading-[88.2px] mt-1 mb-8">
                  Phillie-BOP
                </h2>
                <p className="text-[#FFFFFF] mob:text-center font-normal font-jakrata mob:text-[14px] text-[16px] leading-[30px]">
            ...
            <div className="flex justify-start  tab:justify-center items-center ">
              <Image
                src={buttonimg}
                className=" "
                alt=""
