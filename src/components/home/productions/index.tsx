          ...
          <div className="flex  justify-end tab:justify-center items-center">
            <div className=" relative max-w-[774px] px-[2%]">
              <h2 className="text-gradient  mob:text-center text-left font-outfit font-medium text-[70px] mob:text-[30px] leading-[88.2px] mob:leading-[38px] mb-8">
                Welcome to <br className="mob:hidden" /> Phillie-BOP <br />{" "}
                Productions
              </h2>
          ...
          <div className=" justify-center tab:justify-center items-center">
            <p className="text-[#FFFFFF] mob:text-center font-normal font-jakrata mob:text-[14px] mob:leading-[30px] text-[16px] leading-[33px]  max-w-[615px]">
              <span className="mob:hidden">
                ...
                music of the past, able to fit the elegant adult socials and
                ...
                classic music, providing lush melodies, elegant lyrics, and
                velvet vocals. Listeners will be treated to top-notch quality
                tracks that could be playable in multiple genres. So, they will
                always be ready to drop in almost any kind of set. Phillie-BOP
                Productions is committed to developing new music and artists
                with a reputation for consistent excellence.
                <br /> <br />
              ...
              <span className="hidden mob:block">
                {showFullBio ? (
                  <>
                    <span className="">
                      We are committed to providing a creative home for indie
                      artists, focusing on songwriting, recording, producing,
                      and distributing quality music. Phillie-BOP Productions,
                      LLC was founded in 2010, the original idea of the label
                      was to build a new sleek and sophisticated type of music,
                      providing that urban adult contemporary, smooth R&B/Soul
                      vibe based on elements of classic music of the past, able
                      to fit the elegant adult socials and quiet evenings to
                      unwind.
                    </span>
                    <br /> <br />
                    <span className="">
                  ...
                  <span className="">
                    We are committed to providing a creative home for indie
                    artists, focusing on songwriting, recording, producing, and
                    distributing quality music. Phillie-BOP Productions, LLC was
                    founded in 2010, the original idea of the label was to build
                    a new sleek and sophisticated type of music, providing that
                    urban adult contemporary, smooth R&B/Soul vibe based on
                    elements of classic music of the past, able to fit the
                    elegant adult socials and quiet evenings to unwind.
                  </span>
                )}
              </span>
            </p>
