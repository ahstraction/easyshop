    ...
    <div className=" 2xl:container-fluid flex items-center justify-center bg-transparent pb-14  mx-auto overflow-x-hidden relative gradientpro">
      ...
      <div className="my-16 relative max-w-[1140px] w-full">
        ...
        <div className=" flex mob:block items-start justify-between w-full  relative z-20 mob:px-5  ">
          ...
          We are committed to providing a creative home for indie artists, focusing on
songwriting, recording, producing, and distributing quality music. Phillie-BOP Productions, LLC was founded in 2010, the original idea of the label was to build a new sleek and sophisticated type of music, providing that urban adult
contemporary, smooth R&B/Soul vibe based on elements of classic music of the past, able to fit the elegant adult socials and quiet evenings to unwind.
<br /> <br />


We firmly believe that tracks released on the Phillie-BOP Productions label will be greatly appreciated by lovers of classic music, providing lush melodies, elegant lyrics, and velvet vocals. Listeners will be treated to top-notch quality
tracks that could be playable in multiple genres. So, they will always be ready to drop in almost any kind of set. Phillie-BOP Productions is committed to developing new music and artists with a reputation for consistent
excellence.
<br /> <br />
